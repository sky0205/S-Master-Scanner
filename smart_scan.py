...
# 2. 장마감 후 국장 수급 TOP 10 데이터 (무위험 수익 금액 포함)
...
if not search_query:
    ...
    <div class="report-card">
        ...
        무엇보다 <b>기관의 진짜 매수 평단가</b>보다 현재 주가가 낮은 무위험 수익 구간입니다. <br>
    ...
    with col2:
        ...
        st.write("**Williams %R (14, 6)** ● 수치: -82 (바닥)")
